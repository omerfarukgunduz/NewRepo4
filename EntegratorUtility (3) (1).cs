...
namespace EDONUSUM.CPM.ENTEGRASYON
{
    ...
    public static class EntegratorUtility
    {
        ...
        public class EArsiv : Genel2
        {
            ...
            public override string TopluGonder(List<InvoiceType> Faturalar, List<string> Subeler, bool FarkliSube)
            {
                StringBuilder sb = new StringBuilder();
                var Result = new Results.EFAGDN();
            ...
            public override string Iptal(int EVRAKSN, string EVRAKNO, string GUID, decimal TUTAR)
            {
                switch (UrlModel.SelectedItem)
                {
                    case "FIT":
            ...
            public override string Itiraz(string EVRAKNO, UBL.ObjectionClass Objection)
            {
                switch (UrlModel.SelectedItem)
                {
                    case "FIT":
        ...
        public class EIrsaliye : Genel1
        {
            ...
            //GUID
            public override void Esle(string GUID)
            {
                var Result = new Results.EFAGDN();
                switch (UrlModel.SelectedItem)
                {
            ...
            //EVRAKSN
            public override void Esle(int EVRAKSN, DateTime GonderimTarih, string EVRAKGUID)
            {
                var Result = new Results.EFAGDN();
            ...
            public override void GonderilenGuncelleByDate(DateTime start, DateTime end)
            {
                var Result = new Results.EFAGDN();
                switch (UrlModel.SelectedItem)
                {
        ...
        public class EMustahsil : Genel2
        {
            ...
            public override string Iptal(int EVRAKSN, string UUID, string EVRAKNO, decimal TOTAL)
            {
                switch (UrlModel.SelectedItem)
                {
                    case "FIT":
